...
1. [要件定義](docs/01-requirements.md) — 何を作るか・なぜ作るか
2. [アーキテクチャ設計](docs/02-architecture.md) — 技術スタック・デプロイ構成
3. [機能設計](docs/03-features.md) — 各ページの詳細仕様
4. [開発ガイドライン](docs/04-dev.md) — 規約・コマンド・フロー
...
1. [要件定義](docs/01-requirements.md)
2. [アーキテクチャ設計](docs/02-architecture.md)
3. [機能設計](docs/03-features.md)
4. [開発ガイドライン](docs/04-dev.md)
